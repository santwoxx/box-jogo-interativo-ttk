...
export class TikTokManager {
  constructor(game) {
    ...
    // Official TikTok Live Gifts Catalog (Exact names, real coins and official icons - Balanced for 10k+ HP)
    this.defaultGifts = [
      // Streamer Team Gifts (Ajudam o Streamer a bater no Boss)
      { id: 'rose', name: 'Rosa', coins: 1, icon: '🌹', target: 'player', punchType: 'jab', damage: 2, aliases: ['rose', 'rosa', '5655'] },
      { id: 'tiktok', name: 'TikTok', coins: 1, icon: '🎵', target: 'player', punchType: 'jab', damage: 2, aliases: ['tiktok', 'tiktok logo', '5269'] },
      { id: 'panda', name: 'Mini Panda', coins: 5, icon: '🐼', target: 'player', punchType: 'jab', damage: 10, aliases: ['panda', 'mini panda', '5487'] },
      { id: 'heart', name: 'Heart Me', coins: 10, icon: '💖', target: 'player', punchType: 'cross', damage: 25, aliases: ['heart', 'heart me', 'coração', '5760'] },
      { id: 'sunglasses', name: 'Óculos de Sol', coins: 199, icon: '🕶️', target: 'player', punchType: 'hook', damage: 350, aliases: ['sunglasses', 'oculos', 'óculos', '5657'] },
      { id: 'moneygun', name: 'Money Gun', coins: 500, icon: '🔫', target: 'player', punchType: 'uppercut', damage: 1000, aliases: ['moneygun', 'money gun', 'pistola de dinheiro', '5650'] },
      { id: 'galaxy', name: 'Galáxia', coins: 1000, icon: '🌌', target: 'player', punchType: 'super', damage: 2500, aliases: ['galaxy', 'galaxia', 'galáxia', '5659'] },
      { id: 'universe', name: 'Universo TikTok', coins: 34999, icon: '✨', target: 'player', punchType: 'super', damage: 15000, aliases: ['universe', 'universo', 'tiktok universe', '5844'] },

      // Enemy Team Gifts (Ajudam o Boss / Trollar o Streamer)
      { id: 'icecream', name: 'Casquinha', coins: 1, icon: '🍦', target: 'enemy', punchType: 'jab', damage: 2, aliases: ['ice cream', 'icecream', 'casquinha', 'sorvete', '5879'] },
      { id: 'doughnut', name: 'Rosquinha', coins: 30, icon: '🍩', target: 'enemy', punchType: 'jab', damage: 50, aliases: ['doughnut', 'donut', 'rosquinha', '5827'] },
      { id: 'duck', name: 'Patinho', coins: 50, icon: '🦆', target: 'enemy', punchType: 'jab', damage: 80, aliases: ['duck', 'pato', 'patinho', '5828'] },
      { id: 'cap', name: 'Boné GG', coins: 99, icon: '🧢', target: 'enemy', punchType: 'hook', damage: 180, aliases: ['cap', 'bone', 'boné', 'cap and mustache', '5658'] },
      { id: 'corgi', name: 'Corgi Dog', coins: 299, icon: '🐶', target: 'enemy', punchType: 'hook', damage: 400, aliases: ['corgi', 'dog', 'cachorro'] },
      { id: 'whale', name: 'Baleia', coins: 2150, icon: '🐳', target: 'enemy', punchType: 'uppercut', damage: 3000, aliases: ['whale', 'baleia', 'whale diving'] },
      { id: 'car', name: 'Carro Esportivo', coins: 7000, icon: '🏎️', target: 'enemy', punchType: 'super', damage: 6000, aliases: ['car', 'carro', 'sports car'] },
      { id: 'falcon', name: 'Falcão', coins: 10999, icon: '🦅', target: 'enemy', punchType: 'super', damage: 10000, aliases: ['falcon', 'falcao', 'falcão'] },
      { id: 'lion', name: 'Leão TikTok', coins: 29999, icon: '🦁', target: 'enemy', punchType: 'super', damage: 15000, aliases: ['lion', 'leao', 'leão', '5653'] }
    ];
  ...
  saveSettings() {
    try {
      localStorage.setItem('punch_boxing_gifts_rules_v3', JSON.stringify(this.gifts));
    } catch (e) {
  ...
  loadSavedSettings() {
    try {
      const saved = localStorage.getItem('punch_boxing_gifts_rules_v3');
      if (saved) {
